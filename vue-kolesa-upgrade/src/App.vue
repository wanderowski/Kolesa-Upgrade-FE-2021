                        ...
                        <div class="modal__desc">
                            ...
                            <div class="modal__actions">
                                <div class="modal__info">
                                    <p class="modal__points">баллов</p>
                                    <button class="btn btn--blue modal__btn">
                                        Заказать
                                    </button>
                                </div>
                    ...
                    <div class="main__content">
                        ...
                        <div class="main__points points">
                            ...
                            <button class="points__box points__howto">
                                ...
                                <span class="points__desc"
                                    >Как получить баллы</span
                                >
                            </button>
            ...
            <div class="container">
                <div class="footer__wrapper">
                    <div class="footer__social">
                        <span class="footer__copyright"> © Kolesa Group </span>
                        <div class="footer__icons">
                            <a href="https://vk.com/kolesakz" target="_blank"
                                ><img
                                    src="./assets/VK.png"
                                    alt="VK"
                                    class="footer__icon"
                    ...
                    <div class="footer__contact">
                        <span class="footer__desc">
                            Есть идеи что улучшить?<br />Не знаешь, с кем решить
                            проблему?
                        </span>
        ...
        return {
            clothes: [
                {
                    ...
                    details:
                        "Брендированная футболка. Материал: Хлопок 80%, Вискоза 20%",
                },
                {
                    id: 1,
                    price: 580,
                    ...
                    details:
                        "Брендированная футболка. Материал: Хлопок 75%, Вискоза 25%",
                },
                {
                    id: 2,
                    price: 970,
                    ...
                    details:
                        "Брендированная футболка. Материал: Хлопок 50%, Вискоза 50%",
                },
                {
                    id: 3,
                    price: 860,
                ...
                },
                {
                    ...
                    img: "shirts/angry.jpg",
                    details:
                        "Футболка для самых смелых. Материал: Синтетика 99%, Хлопок 1%",
                },
                {
                    id: 5,
                    price: 310,
            ...
            accessories: [
                ...
                },
                {
                    ...
                    details:
                        "Нарукавник для рук во время бега. Помогает в холодную погоду",
                },
                {
                    id: 8,
                    price: 820,
                ...
                },
                {
                    ...
                    details:
                        "Зимние нарукавники для рук во время бега. Цвет: Синий",
                },
                {
                    id: 11,
                    price: 380,
                    ...
                    details:
                        "Спортивная бутылка для воды из пластика. Цвет: Синий",
                },
            ],
            navItems: [
